...
public class TestDataPopulator {
	...
	private boolean databaseEmpty() {
		...
		try {
			...
			return !connection.getMetaData()
					.getTables(null, null, "AUCTIONS", null).next();
	...
	private void insertAuctions() {
		...
		String starts = timeStampFormatter.print(now.minusDays(10).toDate(),
				no_NO);
		String ends = timeStampFormatter
